---
title: "4 500 enfants ont donné une goutte de sang à neuf ans. Ce qu'elle annonçait à dix-huit"
type: app
...
app_id: 68
study: "Wray NR et al., Nature Genetics 2018"
original_url: "https://www.geneplaza.com/blog/fr/une-revolution-quant-a-notre-facon-de-comprendre-la-depression-va-transformer-nos-vies/"
source: wordpress-migration
rewritten: "2024 - resume original, remplace la traduction integrale d'un article du Guardian"
layout: article.njk
permalink: "blog/fr/une-revolution-quant-a-notre-facon-de-comprendre-la-depression-va-transformer-nos-vies/index.html"
---
...
L'argumentaire complet en faveur de l'inflammation comme contributeur causal, et non comme simple conséquence, est développé par Miller et Raison ([*Nature Reviews Immunology*, 2016](https://doi.org/10.1038/nri.2015.5), PMID : 26711676). Cela reste une hypothèse solidement étayée, pas un fait établi.

## Ce que la génétique a ajouté

En 2018, un consortium piloté depuis l'université du Queensland a mené une méta-analyse d'association pangénomique sur la dépression majeure portant sur **135 458 cas et 344 901 témoins**, et identifié **44 loci indépendants significatifs** ([Wray et al., *Nature Genetics*, 2018](https://doi.org/10.1038/s41588-018-0090-3), PMID : 29700475).
...
Il n'existe pas de gène de la dépression. Il existe une distribution continue du risque, sur laquelle chacun se situe quelque part, construite à partir de nombreux variants dont l'effet individuel est minuscule. Une méta-analyse ultérieure a porté le compte à 102 variants indépendants ([Howard et al., *Nature Neuroscience*, 2019](https://doi.org/10.1038/s41593-018-0326-7), PMID : 30718901).
...
L'[application Depression](https://www.geneplaza.com/app-store/68) applique les résultats de l'analyse de Wray et al. à votre génotype et vous situe sur la distribution de risque polygénique décrite dans cette étude, en citant la source tout du long.
