...
source: original
layout: article.njk
permalink: "blog/en/paleolithic-ice-age-europe-ancestry/index.html"
---
...
For most of the twentieth century, Ice Age Europe was reconstructed from stone tools and cave art. Then researchers sequenced **51 Eurasians who lived between 45,000 and 7,000 years ago**, and found a history no artefact sequence had predicted ([Fu et al., *Nature*, 2016](https://doi.org/10.1038/nature17993), PMID: 27135931).
...
The [Paleolithic Age DNA Test](https://www.geneplaza.com/app-store/79) compares your genotype against ancient gene pools from this period; an [advanced version](https://www.geneplaza.com/app-store/80) resolves a larger set of reference populations.

Both draw on published ancient genomes aggregated in the Allen Ancient DNA Resource ([Mallick et al., *Scientific Data*, 2024](https://doi.org/10.1038/s41597-024-03031-7)). As with every app on the platform, the result tells you where your genome would have been placed within that reference set — a similarity measurement, not a lineage certificate.
